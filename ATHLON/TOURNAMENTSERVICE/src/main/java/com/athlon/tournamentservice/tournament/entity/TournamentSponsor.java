...
public class TournamentSponsor {
    ...
    @Column(name = "tournamentsponsorid", updatable = false, nullable = false)
    private Long id;

    @Column(name = "tournamentsponsoruuid", updatable = false, nullable = false, unique = true)
    private UUID uuid;
