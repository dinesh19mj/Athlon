...
public class ClubRolePermission {
    ...
    private String moduleId; // tournaments, members, matches, attendance, posts, inventory, finances, analytics, settings
    ...
    public ClubRolePermission() {
    }

    public ClubRolePermission(UUID organizationUuid, String role, String moduleId, String accessLevel) {
    ...
    public boolean equals(Object o) {
        ...
        ClubRolePermission that = (ClubRolePermission) o;
