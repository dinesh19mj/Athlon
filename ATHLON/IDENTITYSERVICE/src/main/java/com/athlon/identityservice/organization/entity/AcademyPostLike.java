...
@Entity
@Table(
    name = "academy_post_likes",
    uniqueConstraints = {
        @UniqueConstraint(name = "uk_academy_post_user_like", columnNames = {"post_uuid", "user_uuid"})
    }
)
public class AcademyPostLike {
