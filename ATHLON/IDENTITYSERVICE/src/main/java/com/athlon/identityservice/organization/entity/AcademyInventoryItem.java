...
@Entity
@Table(name = "academy_inventory_items")
public class AcademyInventoryItem {
    ...
    private String location; // Court 1 Cabinet, Coach Locker, Shelf B, Campus Arena
