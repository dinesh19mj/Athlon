...
@Entity
@Table(name = "organizer_role_permissions")
public class OrganizerRolePermission {
    ...
    private String moduleId; // tournaments, registrations, matches, scoring, inventory, finances, livestream, officials, settings
    ...
    public OrganizerRolePermission() {
    }

    public OrganizerRolePermission(UUID organizationUuid, String role, String moduleId, String accessLevel) {
        this.organizationUuid = organizationUuid;
        this.role = role != null ? role.toUpperCase() : "TOURNAMENT_DIRECTOR";
        this.moduleId = moduleId != null ? moduleId.toLowerCase() : "tournaments";
    ...
    public boolean equals(Object o) {
        ...
        OrganizerRolePermission that = (OrganizerRolePermission) o;
