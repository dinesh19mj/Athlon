...
@Entity
@Table(name = "organizer_inventory_items")
public class OrganizerInventoryItem {
    ...
    private String unit = "Units"; // Tubes, Pieces, Sets, Boxes, Pairs, Kits

    @Column(name = "location", length = 100)
    private String location; // Court Desk 1, Arena Store, Main Office, Court 3
    ...
    private String conditionStatus = "NEW"; // NEW, GOOD, FAIR, DAMAGED, DISPOSED
