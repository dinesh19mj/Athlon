            ...
            <div className="grid grid-cols-12 gap-8 items-center">
              ...
              <div className="col-span-8 space-y-4">
                <div className="flex items-center gap-2.5 flex-wrap">
                  ...
                  <span className="px-3 py-1 rounded-full bg-white/5 border border-white/10 text-foreground/80 text-xs font-bold uppercase tracking-wider">
                    {isTeamEvent ? 'Team League' : isLeague ? 'League' : 'Knockout'}
                  </span>
                </div>
                ...
                <div className="grid grid-cols-4 gap-4 pt-2">
                  ...
                  <div className="p-3.5 rounded-2xl border bg-surface/50 space-y-1" style={{ borderColor: 'var(--athlon-border)' }}>
                    ...
                    <div className="text-sm font-black text-foreground">
                      {registrations.length} {tournament.playersCount ? `/ ${tournament.playersCount}` : 'Players'}
                    </div>
                  </div>
                  <div className="p-3.5 rounded-2xl border bg-surface/50 space-y-1" style={{ borderColor: 'var(--athlon-border)' }}>
              ...
              <div className="col-span-4">
                {posterUrl ? (
                  <div className="w-full h-72 rounded-[28px] overflow-hidden border shadow-2xl relative" style={{ borderColor: 'var(--athlon-border)' }}>
                    <img src={posterUrl} alt={tournament.name} className="w-full h-full object-cover" />
                  </div>
                ) : (
                  <div
