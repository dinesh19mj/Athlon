            ...
            <div className="flex items-center justify-between gap-4">
              ...
              >
                ...
                >
                  ...
                  <span
                    className={`text-[10px] px-2 py-0.5 rounded-full font-mono font-black shrink-0 ${
                      activeTab === 'live' ? 'bg-black/20 text-white' : 'bg-white/10 text-foreground/50'
                    }`}
                  >
                ...
                >
                  ...
                  <span
                    className={`text-[10px] px-2 py-0.5 rounded-full font-mono font-black shrink-0 ${
                      activeTab === 'finished' ? 'bg-black/20 text-black' : 'bg-white/10 text-foreground/50'
                    }`}
                  >
