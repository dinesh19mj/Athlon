      ...
      <div className="block md:hidden pb-32">
        ...
        <div className="max-w-4xl mx-auto px-3.5 sm:px-6 py-4 space-y-5">
          ...
          >
            ...
            {posterUrl ? (
              <div className="w-full h-44 sm:h-64 relative bg-black/60 overflow-hidden">
                <img
                  src={posterUrl}
                ...
                <div className="absolute top-3 left-3 right-3 flex items-center justify-between z-10">
                  ...
                  <span className="px-2.5 py-1 rounded-xl text-[10px] font-mono font-black text-primary bg-black/70 backdrop-blur-md border border-primary/30">
                    {championship.teamRegistrationFee ? `₹${championship.teamRegistrationFee}/Team` : 'FREE ENTRY'}
                  </span>
                </div>
              </div>
            ) : (
              <div className="w-full h-28 sm:h-36 relative bg-gradient-to-br from-primary/20 via-background to-amber-500/10 p-3.5 flex flex-col justify-between">
            ...
            <div className="p-4 sm:p-6 -mt-8 sm:-mt-12 relative z-10 space-y-3.5">
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8 py-10">
            <div className="grid grid-cols-12 gap-8 items-center">
              ...
              <div className="col-span-4">
                {posterUrl ? (
                  <div className="w-full h-72 rounded-[28px] overflow-hidden border shadow-2xl relative" style={{ borderColor: 'var(--athlon-border)' }}>
                    <img src={posterUrl} alt={championship.name} className="w-full h-full object-cover" />
                  </div>
                ) : (
                  <div
                  ...
                  >
                    ...
                    <span className="text-xs font-black text-foreground/60 uppercase tracking-widest">{championship.sport} League Arena</span>
                  </div>
                )}
              </div>
            </div>
